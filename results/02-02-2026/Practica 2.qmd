...
```{bash}
wsl git config --global user.name "DjTheorn"
wsl git config --global user.email "tecas@alumni.uv.es"
```
...
#Si usamos simplemente git add ., se añadiran a git todos los cambios
