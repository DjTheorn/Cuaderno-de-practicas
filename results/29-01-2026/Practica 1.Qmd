...
#Recomendación y lo que el nos propone: que las subcarpetas tengan nombres del día en que se comenzó el proyecto.
```
:::
...
wsl exonerate --model est2genome HumanSMARCD2.fa HumanChr17.fa
```
...
if [ ! -e PF00009.fa ]; then
  wsl wget -O PF00009.fa https://raw.githubusercontent.com/rcedgar/balifam/refs/heads/main/balifam100/in/PF00009.100
fi

if [ ! -e PF00009.afa ]; then
  wsl muscle -align PF00009.fa -output PF00009.afa
fi
```
...
#Para salir de los paginadores, presionamos q


#Para cambiar el PATH:
#Si en el home buscamos todos los archivos (ls - lha), nos sale .bashrc. Si entramos dentro y ponemos export PATH=/.../:$PATH, nos buscará dónde queremos. 

#Para pedir ayuda: 
#Usamos el programa man. man -k es muy util xq nos da varias opciones
